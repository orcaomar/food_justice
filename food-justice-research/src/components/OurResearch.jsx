...
const OurResearch = () => {
  return (
    <section className="our-research" aria-labelledby="our-research-heading">
      <div className="research-content">
        <div className="research-image">
          <ResponsiveImage
            src={researchImg}
            alt="Community members and food justice researchers collaborating in Thorncliffe and Flemingdon Park"
          />
        </div>
        <div className="research-text">
          <h2 id="our-research-heading">Our Research</h2>
          ...
          <Link to="/research" className="learn-more-button" aria-label="Learn more about our research">
            Learn more
          </Link>
        </div>
      </div>
